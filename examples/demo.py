"""Runnable ARAG demo — no external LLM server required.
...
def main():
    ...
    print("=" * 70)
    rag = ARAG(llm=offline_llm())  # preset='quality'
    rep = rag.add(corpus())
